...
Describe 'New-PSCodeHealthComplianceRule' {
    ...
    $FunctionMetricMaximumNestingDepth = $MetricsRules.FunctionHealthRecordMetricsRules | Where-Object { $_.MaximumNestingDepth }
    $OverallMetricLinesOfCodeTotal = $MetricsRules.OverallHealthReportMetricsRules | Where-Object { $_.LinesOfCodeTotal }

        Context 'The specified SettingsGroup is FunctionHealthRecordMetricsRules' {

            $Result = New-PSCodeHealthComplianceRule -MetricRule $FunctionMetricMaximumNestingDepth -SettingsGroup FunctionHealthRecordMetricsRules
            ...
            It 'Should return an object with the expected property "SettingsGroup"' {
                $Result.SettingsGroup | Should Be 'FunctionHealthRecordMetricsRules'
            }
        ...
        Context 'The specified SettingsGroup is FunctionHealthRecordMetricsRules' {
            ...
            $Result = New-PSCodeHealthComplianceRule -MetricRule $OverallMetricLinesOfCodeTotal -SettingsGroup OverallHealthReportMetricsRules
            ...
            It 'Should return an object with the expected property "SettingsGroup"' {
                $Result.SettingsGroup | Should Be 'OverallHealthReportMetricsRules'
            }
            It 'Should return an object with the expected property "MetricName"' {
